        ...
        <div class="container my-4">
            <div class="card">
                <div class="card-header text-white">
                    <h2 class="text-center text-light">{{__('pay.edit_payment_method')}}</h2>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('pagos.update', $pago->id) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <x-text-input id="metodo_pago" class="form-control" type="text" name="metodo_pago" value="{{ $pago->metodo_pago }}" required />
